...
- "Everything is behind interfaces with dependency injection, so the tests use fake embedders and a fake LLM: 36 tests run in half a second with no network."
